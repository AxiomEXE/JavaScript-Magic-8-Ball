...
let userName = '';
userName ? console.log('Hello, Jane!') : console.log('Hello, friend!');
const userQuestion = 'Will I win the jackpot?';
console.log(`${userName || 'Friend'} asked, '${userQuestion}'.`);
